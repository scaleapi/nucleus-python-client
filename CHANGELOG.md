...
## [0.14.28](https://github.com/scaleapi/nucleus-python-client/releases/tag/v0.14.28) - 2022-11-16

### Added
- Support for `Track`s in Nucleus, enabling ground truth annotations and model predictions to be grouped across dataset items and scenes
